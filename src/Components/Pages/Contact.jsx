...
const Contact = () => {
  return (
    <>
     <section class="min-h-screen py-10 bg-gray-100 dark:bg-gray-900 lg:flex">
    <div class="flex flex-col shadow-2xl justify-center w-full p-8 lg:bg-gray-200 lg:dark:bg-gray-800 lg:px-12 xl:px-32 lg:w-1/2">
        ...
        Hey there! We're thrilled to have you here at EnergyPro. Our team is eager to assist you with any questions or feedback. Drop us a message, and we'll get back to you in no time!
        </p>

        <div class="mt-6 md:mt-8">
            <h3 class="font-medium text-gray-700 dark:text-gray-300 ">Follow us</h3>
            ...
            <div class="flex mt-4 -mx-1.5 ">
                ...
                <a class="mx-1.5 dark:hover:text-blue-400 text-gray-500 transition-colors duration-300 transform hover:text-blue-800" href="#">
                    <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M7 10.2222V13.7778H9.66667V20H13.2222V13.7778H15.8889L16.7778 10.2222H13.2222V8.44444C13.2222 8.2087 13.3159 7.9826 13.4826 7.81591C13.6493 7.64921 13.8754 7.55556 14.1111 7.55556H16.7778V4H14.1111C12.9324 4 11.8019 4.46825 10.9684 5.30175C10.1349 6.13524 9.66667 7.2657 9.66667 8.44444V10.2222H7Z" fill="currentColor" />
                    </svg>
                </a>

                <a class="mx-1.5 dark:hover:text-blue-400 text-gray-500 transition-colors duration-300 transform hover:text-pink-600" href="#">
                    <svg class="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
